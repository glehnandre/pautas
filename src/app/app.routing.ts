...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'julgamento-extraordinario', loadChildren: () => import('app/modules/resposta-solicitacao-sessao-extraordinaria/resposta-solicitacao-sessao-extraordinaria.module').then(m => m.JulgamentoExtraordinarioModule)},
